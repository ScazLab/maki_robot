class dynamixelConversions(object):
	...
	def getPoseRadian_tick( self, tick ):
		ret = ( float(tick) / dynamixelConversions.TICKS_PER_DEGREE ) * dynamixelConversions.RADIANS_PER_DEGREE
		return ret

	def getPoseTick_radian( self, radian ):
		ret = ( float(radian) / dynamixelConversions.RADIANS_PER_DEGREE ) * dynamixelConversions.TICKS_PER_DEGREE
